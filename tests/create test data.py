...
for i in range(1, save_num+1):
    src_file = f'tests/sample_save{str(save_num)}.sav'
    dummy_save_file = f'tests/save_data{str(save_num)}.json'
    ...
    test_list.append(f'        ("tests/sample_save{i}.sav", "tests/save_data{i}.json"),\n')
